...
describe("PATCH /companies/:handle", function () {
  test("doesn't works for users", async function () {
    const resp = await request(app)
      .patch(`/companies/c1`)
      .send({
        name: "C1-new",
  ...
  test("not found on no such company, for users", async function () {
    const resp = await request(app)
  ...
  test("bad request on handle change attempt for users", async function () {
    const resp = await request(app)
      .patch(`/companies/c1`)
      .send({
        handle: "c1-new",
